...
[![](https://github.com/wutsi/linkedin-server/actions/workflows/scheduled_run.yml/badge.svg)](https://github.com/wutsi/linkedin-server/actions/workflows/scheduled_run.yml)
...
- Create a database named `linkedin`
...
- Install
```
$ git clone git@github.com:wutsi/linkedin-server.git
```
